...
export const plants: Plant[] = [
  ...
  p("dahlia", "Dahlia", 350, "Flowering", dhalia, "Show-stopping double blooms in vivid colours.", "Full sun", "Twice weekly", "in"),
  ...
  p("gaillardia", "Gaillardia (Blanket Flower)", 250, "Flowering", gillardia, "Sunset-bicolour daisies that bloom forever.", "Full sun", "Weekly", "in"),
  ...
  p("rajnigandha", "Rajnigandha (Tuberose)", 400, "Flowering", Rajnigandh, "Tall white spikes with intoxicating fragrance.", "Full sun", "Twice weekly", "in"),
