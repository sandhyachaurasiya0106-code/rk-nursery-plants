...
export const plants: Plant[] = [
  ...
  p("spider-plant", "Spider Plant", 350, "Indoor", spiderplant, "Arching striped leaves and easy babies. Cleans the air.", "Bright indirect", "Weekly", "in", "Chlorophytum comosum"),
  ...
  p("areca", "Areca Palm", 650, "Indoor", arecapalm, "Tropical softness and serious air-purifying power.", "Bright indirect", "Twice weekly", "in", "Dypsis lutescens"),
  p("rubber", "Rubber Plant", 400, "Indoor", rubberplant, "Burgundy-tinged leaves with a high-gloss finish.", "Bright indirect", "Weekly", "in", "Ficus elastica"),
  ...
  p("jade-indoor", "Jade Plant", 300, "Indoor", jadeplant, "Plump succulent said to bring prosperity.", "Bright sun", "Every 2 weeks", "in", "Crassula ovata"),
  ...
  p("dracaena-marginata", "Dracaena Marginata", 600, "Indoor", dracaenamarginata, "Slender stems crowned with red-edged blades.", "Bright indirect", "Weekly", "in"),
  ...
  p("chinese-money", "Chinese Money Plant (Pilea)", 400, "Indoor", chinesemoney, "Round pancake leaves on slender stems.", "Bright indirect", "Weekly", "in"),
  ...
  p("fiddle-leaf", "Fiddle Leaf Fig", 750, "Indoor", fiddleleaf, "Tall, glossy, dramatic. A living centerpiece.", "Bright indirect", "Weekly", "in", "Ficus lyrata"),
  p("english-ivy", "English Ivy", 350, "Indoor", englishivy, "Classic trailing vines for shelves and walls.", "Bright indirect", "Weekly", "in"),
  ...
  p("nerve-plant", "Nerve Plant (Fittonia)", 250, "Indoor", nerve-plan, "Tiny leaves veined in white or pink.", "Medium indirect", "Twice weekly", "in"),
  ...
  p("baby-rubber", "Baby Rubber Plant", 350, "Indoor", babyrubber, "Thick glossy leaves on a compact bush.", "Bright indirect", "Every 10 days", "in"),
  p("schefflera", "Schefflera (Umbrella Tree)", 600, "Indoor", schefflera, "Glossy umbrella-spoke leaves on graceful stems.", "Bright indirect", "Weekly", "in"),
  ...
  p("araucaria", "Araucaria (Christmas Tree)", 850, "Outdoor", araucaria, "Symmetrical layered conifer. Festive year-round.", "Full to part sun", "Weekly", "in"),
  p("cassia fistula", "Cassia Fistula (Amaltas)", 500, "Outdoor", cassia fistula, "Cascading golden flower chains in summer.", "Full sun", "Twice weekly", "in"),
  p("gulmohar", "Gulmohar", 550, "Outdoor", gulmohar, "Flame-orange canopy that defines Indian summers.", "Full sun", "Twice weekly", "in"),
  p("karanj", "Karanj (Indian Beech)", 450, "Outdoor", karanj, "Dense shade tree with medicinal seeds.", "Full sun", "Twice weekly", "in"),
  p("kadamba", "Kadamba", 500, "Outdoor", kadamba, "Sacred shade tree with orange ball blooms.", "Full sun", "Twice weekly", "in"),
  p("plumeria", "Plumeria (Frangipani)", 700, "Outdoor", plumeria, "Fragrant five-petal blooms in cream and pink.", "Full sun", "Weekly", "in"),
  p("duranta", "Duranta (Golden Dewdrop)", 350, "Outdoor", duranta, "Bright lime hedge plant with purple sprays.", "Full to part sun", "Twice weekly", "in"),
  p("ficus-panda", "Ficus Panda", 800, "Outdoor", ficus, "Compact glossy bonsai-style ficus.", "Full to part sun", "Weekly", "in"),
  p("jatropha", "Jatropha", 450, "Outdoor", jatropha, "Constant clusters of coral-red blooms.", "Full sun", "Weekly", "in"),
  p("ixora-out", "Ixora", 400, "Outdoor", ixoraout, "Dense flower clusters in red, orange, or pink.", "Full sun", "Twice weekly", "in"),
  p("raat-rani", "Raat Rani (Night Jasmine)", 500, "Outdoor", raatrani, "Tiny white blooms with an unforgettable night fragrance.", "Full to part sun", "Twice weekly", "in"),
  ...
  p("pandanus", "Pandanus (Screw Pine)", 700, "Outdoor", pandanus, "Spiral sword-shaped leaves for coastal looks.", "Full sun", "Weekly", "in"),
  p("acalypha", "Acalypha", 400, "Outdoor", acalypha, "Coloured foliage hedge in bronze and pink.", "Full to part sun", "Twice weekly", "in"),
  p("cycas", "Cycas (Sago Palm)", 1200, "Outdoor", cycas, "Architectural prehistoric palm. Statement plant.", "Full to part sun", "Weekly", "in"),
  p("washingtonia", "Washingtonia Palm", 1500, "Outdoor", washingtonia, "Tall fan palm for grand driveways.", "Full sun", "Twice weekly", "in"),
  ...
  p("tabebuia", "Tabebuia", 800, "Outdoor", tabebuia, "Cloud of pink trumpet blooms in spring.", "Full sun", "Weekly", "in"),
  p("jacaranda", "Jacaranda", 750, "Outdoor", jacaranda, "Violet-blue blossoms that carpet the ground.", "Full sun", "Weekly", "in"),
  p("ficus-benjamina", "Ficus Benjamina", 850, "Outdoor", ficusbenjamina, "Bushy glossy easy-to-shape screen plant.", "Full to part sun", "Weekly", "in", "Ficus benjamina"),
  ...
  p("ixora", "Ixora (Flowering)", 400, "Flowering", ixora, "Dense ball-clusters in coral and pink.", "Full sun", "Twice weekly", "in"),
  p("periwinkle", "Periwinkle (Sadabahar)", 200, "Flowering", periwinkle, "Pink and white blooms all year. Tough as nails.", "Full sun", "Twice weekly", "in"),
  ...
  p("zinnia", "Zinnia", 200, "Flowering", zinnia, "Heat-loving cut-flower that blooms for months.", "Full sun", "Twice weekly", "in"),
  p("sunflower", "Sunflower", 250, "Flowering", sunflower, "Cheerful golden faces that track the sun.", "Full sun", "Twice weekly", "in"),
  p("cosmos", "Cosmos", 200, "Flowering", cosmos, "Airy pink and white meadow blooms.", "Full sun", "Twice weekly", "in"),
  p("pansy", "Pansy", 250, "Flowering", pansy, "Velvety bicolour blooms for cool-season pots.", "Bright sun", "Twice weekly", "in"),
  p("calendula", "Calendula", 200, "Flowering", calendula, "Golden-orange blooms with herbal uses.", "Full sun", "Twice weekly", "in"),
  p("portulaca", "Portulaca", 150, "Flowering", portulaca, "Heat-loving moss-rose carpet in jewel tones.", "Full sun", "Weekly", "in"),
  p("gaillardia", "Gaillardia (Blanket Flower)", 250, "Flowering", gaillardia, "Sunset-bicolour daisies that bloom forever.", "Full sun", "Weekly", "in"),
  p("verbena", "Verbena", 250, "Flowering", verbena, "Compact clusters in purple, pink, and red.", "Full sun", "Twice weekly", "in"),
  p("salvia", "Salvia", 300, "Flowering", salvia, "Spiky purple or red flower wands.", "Full sun", "Twice weekly", "in"),
  p("lantana", "Lantana", 250, "Flowering", lantana, "Multi-colour clusters that attract butterflies.", "Full sun", "Weekly", "in"),
  p("aster", "Aster", 300, "Flowering", aster, "Mauve, pink, and white daisy-form blooms.", "Full sun", "Twice weekly", "in"),
  p("rajnigandha", "Rajnigandha (Tuberose)", 400, "Flowering", rajnigandha, "Tall white spikes with intoxicating fragrance.", "Full sun", "Twice weekly", "in"),
  p("crossandra", "Crossandra (Aboli)", 300, "Flowering", crossandra, "Fan-shaped orange blooms loved in pujas.", "Full to part sun", "Twice weekly", "in"),
  p("balsam", "Balsam (Gulmehndi)", 200, "Flowering", balsam, "Old-school cottage blooms in jewel colours.", "Full to part sun", "Twice weekly", "in"),
  p("poinsettia", "Poinsettia", 450, "Flowering", poinsettia, "Christmas star with flame-red bracts.", "Bright indirect", "Weekly", "in"),
  p("clitoria", "Clitoria (Aparajita)", 300, "Flowering", clitoria, "Deep blue blooms used for herbal tea.", "Full sun", "Twice weekly", "in"),
  ...
  p("papaya", "Papaya", 350, "Fruit", guava, "Fast-growing softwood tree. Fruits within a year.", "Full sun", "Twice weekly", "in"),
  ...
  p("blackberry", "Blackberry", 500, "Fruit", guava, "Trailing cane with sweet-tart berries.", "Full sun", "Twice weekly", "in"),
  p("mulberry", "Mulberry", 450, "Fruit", guava, "Easy garden tree with abundant berries.", "Full sun", "Twice weekly", "in"),
  p("jamun", "Jamun", 700, "Fruit", guava, "Deep purple Indian fruit with sweet-astringent bite.", "Full sun", "Twice weekly", "in"),
  ...
  p("star-fruit", "Star Fruit (Carambola)", 700, "Fruit", guava, "Ribbed fruit that slices into stars.", "Full sun", "Twice weekly", "in"),
  ...
  p("zebra-haworthia", "Zebra Haworthia", 350, "Succulents", jade, "Striking white-banded mini rosette.", "Bright indirect", "Every 2 weeks", "in"),
