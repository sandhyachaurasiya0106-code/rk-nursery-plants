...
export const plants: Plant[] = [
  ...
  p("spider-plant", "Spider Plant", 350, "Indoor", snake, "Arching striped leaves and easy babies. Cleans the air.", "Bright indirect", "Weekly", "in", "Chlorophytum comosum"),
  ...
  p("aglaonema", "Aglaonema (Chinese Evergreen)", 550, "Indoor", peacelily, "Painted leaves in silver, pink, and deep green.", "Low to medium", "Weekly", "in"),
  ...
  p("birds-nest-fern", "Bird's Nest Fern", 500, "Indoor", areca, "Rosette of bright green ripple-edged fronds.", "Medium indirect", "Weekly", "in"),
  ...
  p("fiddle", "Fiddle Leaf Fig", 750, "Indoor", fiddle, "Tall, glossy, dramatic. A living centerpiece.", "Bright indirect", "Weekly", "in", "Ficus lyrata"),
  ...
  p("dieffenbachia", "Dieffenbachia (Dumb Cane)", 500, "Indoor", peacelily, "Bold cream-splashed leaves with tropical drama.", "Bright indirect", "Weekly", "in"),
  ...
  p("calathea", "Calathea", 550, "Indoor", peacelily, "Painted leaves that fold up at night.", "Medium indirect", "Weekly", "in"),
  ...
  p("schefflera", "Schefflera (Umbrella Tree)", 600, "Indoor", fiddle, "Glossy umbrella-spoke leaves on graceful stems.", "Bright indirect", "Weekly", "in"),
  ...
  p("moringa", "Moringa (Drumstick)", 300, "Outdoor", ficus, "Fast-growing superfood tree. Edible pods and leaves.", "Full sun", "Weekly", "in", "Moringa oleifera"),
  ...
  p("araucaria", "Araucaria (Christmas Tree)", 850, "Outdoor", bamboo, "Symmetrical layered conifer. Festive year-round.", "Full to part sun", "Weekly", "in"),
  p("cassia", "Cassia Fistula (Amaltas)", 500, "Outdoor", ashoka, "Cascading golden flower chains in summer.", "Full sun", "Twice weekly", "in"),
  p("gulmohar", "Gulmohar", 550, "Outdoor", ashoka, "Flame-orange canopy that defines Indian summers.", "Full sun", "Twice weekly", "in"),
  ...
  p("pandanus", "Pandanus (Screw Pine)", 700, "Outdoor", bamboo, "Spiral sword-shaped leaves for coastal looks.", "Full sun", "Weekly", "in"),
  p("acalypha", "Acalypha", 400, "Outdoor", croton, "Coloured foliage hedge in bronze and pink.", "Full to part sun", "Twice weekly", "in"),
  p("cycas", "Cycas (Sago Palm)", 1200, "Outdoor", bamboo, "Architectural prehistoric palm. Statement plant.", "Full to part sun", "Weekly", "in"),
  p("washingtonia", "Washingtonia Palm", 1500, "Outdoor", areca, "Tall fan palm for grand driveways.", "Full sun", "Twice weekly", "in"),
  p("foxtail", "Foxtail Palm", 1400, "Outdoor", areca, "Bushy plume-like fronds. Elegant entryway palm.", "Full sun", "Twice weekly", "in"),
  p("tabebuia", "Tabebuia", 800, "Outdoor", ashoka, "Cloud of pink trumpet blooms in spring.", "Full sun", "Weekly", "in"),
  p("jacaranda", "Jacaranda", 750, "Outdoor", ashoka, "Violet-blue blossoms that carpet the ground.", "Full sun", "Weekly", "in"),
