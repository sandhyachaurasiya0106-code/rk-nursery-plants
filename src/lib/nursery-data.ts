...
// New unique lifestyle photos
import spider from "@/assets/plant-spider.jpg";
import money from "@/assets/plant-money.jpg";
import luckybamboo from "@/assets/plant-luckybamboo.jpg";
import aglaonema from "@/assets/plant-aglaonema.jpg";
import syngonium from "@/assets/plant-syngonium.jpg";
import philodendron from "@/assets/plant-philodendron.jpg";
import pothosneon from "@/assets/plant-pothosneon.jpg";
import dracaena from "@/assets/plant-dracaena.jpg";
import bostonfern from "@/assets/plant-bostonfern.jpg";
import birdsnestfern from "@/assets/plant-birdsnestfern.jpg";
import parlorpalm from "@/assets/plant-parlorpalm.jpg";
import pilea from "@/assets/plant-pilea.jpg";
import anthurium from "@/assets/plant-anthurium.jpg";
import ivy from "@/assets/plant-ivy.jpg";
import peperomia from "@/assets/plant-peperomia.jpg";
import dieffenbachia from "@/assets/plant-dieffenbachia.jpg";
import fittonia from "@/assets/plant-fittonia.jpg";
import calathea from "@/assets/plant-calathea.jpg";
import alocasia from "@/assets/plant-alocasia.jpg";
import neem from "@/assets/plant-neem.jpg";
import banyan from "@/assets/plant-banyan.jpg";
import peepal from "@/assets/plant-peepal.jpg";
import moringa from "@/assets/plant-moringa.jpg";
import bottlebrush from "@/assets/plant-bottlebrush.jpg";
import goldencypress from "@/assets/plant-goldencypress.jpg";
import gulmohar from "@/assets/plant-gulmohar.jpg";
import plumeria from "@/assets/plant-plumeria.jpg";
import cycas from "@/assets/plant-cycas.jpg";
import foxtailpalm from "@/assets/plant-foxtailpalm.jpg";
import jacaranda from "@/assets/plant-jacaranda.jpg";
import marigold from "@/assets/plant-marigold.jpg";
import mogra from "@/assets/plant-mogra.jpg";
import petunia from "@/assets/plant-petunia.jpg";
import chrysanthemum from "@/assets/plant-chrysanthemum.jpg";
import dahlia from "@/assets/plant-dahlia.jpg";
import gerbera from "@/assets/plant-gerbera.jpg";
import sunflower from "@/assets/plant-sunflower.jpg";
import tuberose from "@/assets/plant-tuberose.jpg";
import adenium from "@/assets/plant-adenium.jpg";
import tecoma from "@/assets/plant-tecoma.jpg";
import papaya from "@/assets/plant-papaya.jpg";
import banana from "@/assets/plant-banana.jpg";
import coconut from "@/assets/plant-coconut.jpg";
import dragonfruit from "@/assets/plant-dragonfruit.jpg";
import strawberry from "@/assets/plant-strawberry.jpg";
import jamun from "@/assets/plant-jamun.jpg";
import fig from "@/assets/plant-fig.jpg";
import avocado from "@/assets/plant-avocado.jpg";
import pineapple from "@/assets/plant-pineapple.jpg";
import amla from "@/assets/plant-amla.jpg";
import tulsi from "@/assets/plant-tulsi.jpg";
import curryleaf from "@/assets/plant-curryleaf.jpg";
import lemongrass from "@/assets/plant-lemongrass.jpg";
import mint from "@/assets/plant-mint.jpg";
import turmeric from "@/assets/plant-turmeric.jpg";
import ginger from "@/assets/plant-ginger.jpg";
import haworthia from "@/assets/plant-haworthia.jpg";
import stringpearls from "@/assets/plant-stringpearls.jpg";
import lithops from "@/assets/plant-lithops.jpg";
import agave from "@/assets/plant-agave.jpg";
...
export const plants: Plant[] = [
  ...
  p("spider-plant", "Spider Plant", 350, "Indoor", spider, "Arching striped leaves and easy babies. Cleans the air.", "Bright indirect", "Weekly", "in", "Chlorophytum comosum"),
  ...
  p("money-plant", "Money Plant (Pothos)", 250, "Indoor", money, "Trailing heart-shaped leaves. The classic Indian indoor.", "Low to bright", "Weekly", "in", "Epipremnum aureum"),
  ...
  p("lucky-bamboo", "Lucky Bamboo", 350, "Indoor", luckybamboo, "Calm vertical stalks for desks and entryways.", "Bright indirect", "Keep in water", "in", "Dracaena sanderiana"),
  p("aglaonema", "Aglaonema (Chinese Evergreen)", 550, "Indoor", aglaonema, "Painted leaves in silver, pink, and deep green.", "Low to medium", "Weekly", "in"),
  p("syngonium", "Syngonium (Arrowhead Plant)", 300, "Indoor", syngonium, "Soft arrow-shaped leaves that climb or trail.", "Bright indirect", "Weekly", "in"),
  p("philodendron", "Philodendron", 400, "Indoor", philodendron, "Glossy heart-leaf vines for shelves and frames.", "Bright indirect", "Weekly", "in"),
  p("pothos-neon", "Pothos Neon", 350, "Indoor", pothosneon, "Electric chartreuse trails that glow in low light.", "Low to bright", "Weekly", "in"),
  p("dracaena-marginata", "Dracaena Marginata", 600, "Indoor", dracaena, "Slender stems crowned with red-edged blades.", "Bright indirect", "Weekly", "in"),
  p("boston-fern", "Boston Fern", 450, "Indoor", bostonfern, "Lush, feathery fronds — perfect for humid bathrooms.", "Bright indirect", "Twice weekly", "in"),
  p("birds-nest-fern", "Bird's Nest Fern", 500, "Indoor", birdsnestfern, "Rosette of bright green ripple-edged fronds.", "Medium indirect", "Weekly", "in"),
  p("parlor-palm", "Parlor Palm", 550, "Indoor", parlorpalm, "Compact, low-light tolerant palm for cosy corners.", "Low to medium", "Weekly", "in"),
  p("chinese-money", "Chinese Money Plant (Pilea)", 400, "Indoor", pilea, "Round pancake leaves on slender stems.", "Bright indirect", "Weekly", "in"),
  p("anthurium", "Anthurium", 650, "Indoor", anthurium, "Waxy red flag-flowers above dark foliage.", "Bright indirect", "Weekly", "in"),
  ...
  p("english-ivy", "English Ivy", 350, "Indoor", ivy, "Classic trailing vines for shelves and walls.", "Bright indirect", "Weekly", "in"),
  p("peperomia", "Peperomia", 300, "Indoor", peperomia, "Compact rosettes of thick, textured leaves.", "Bright indirect", "Every 10 days", "in"),
  p("dieffenbachia", "Dieffenbachia (Dumb Cane)", 500, "Indoor", dieffenbachia, "Bold cream-splashed leaves with tropical drama.", "Bright indirect", "Weekly", "in"),
  p("nerve-plant", "Nerve Plant (Fittonia)", 250, "Indoor", fittonia, "Tiny leaves veined in white or pink.", "Medium indirect", "Twice weekly", "in"),
  p("calathea", "Calathea", 550, "Indoor", calathea, "Painted leaves that fold up at night.", "Medium indirect", "Weekly", "in"),
  p("alocasia", "Alocasia", 700, "Indoor", alocasia, "Sculptural arrow leaves with bold veining.", "Bright indirect", "Weekly", "in"),
  ...
  p("neem", "Neem Tree", 350, "Outdoor", neem, "Sacred medicinal tree. Hardy and air-purifying.", "Full sun", "Twice weekly", "in", "Azadirachta indica"),
  p("banyan", "Banyan", 600, "Outdoor", banyan, "Iconic sprawling sacred tree. Strong character.", "Full sun", "Twice weekly", "in", "Ficus benghalensis"),
  p("peepal", "Peepal", 400, "Outdoor", peepal, "Heart-shaped trembling leaves. Deeply revered.", "Full sun", "Twice weekly", "in", "Ficus religiosa"),
  p("moringa", "Moringa (Drumstick)", 300, "Outdoor", moringa, "Fast-growing superfood tree. Edible pods and leaves.", "Full sun", "Weekly", "in", "Moringa oleifera"),
  p("bottle-brush", "Bottle Brush", 550, "Outdoor", bottlebrush, "Crimson cylindrical blooms loved by birds.", "Full sun", "Twice weekly", "in"),
  p("golden-cypress", "Golden Cypress", 750, "Outdoor", goldencypress, "Bright golden conifer for hedges and entries.", "Full sun", "Twice weekly", "in"),
  ...
  p("gulmohar", "Gulmohar", 550, "Outdoor", gulmohar, "Flame-orange canopy that defines Indian summers.", "Full sun", "Twice weekly", "in"),
  ...
  p("plumeria", "Plumeria (Frangipani)", 700, "Outdoor", plumeria, "Fragrant five-petal blooms in cream and pink.", "Full sun", "Weekly", "in"),
  ...
  p("cycas", "Cycas (Sago Palm)", 1200, "Outdoor", cycas, "Architectural prehistoric palm. Statement plant.", "Full to part sun", "Weekly", "in"),
  p("washingtonia", "Washingtonia Palm", 1500, "Outdoor", areca, "Tall fan palm for grand driveways.", "Full sun", "Twice weekly", "in"),
  p("foxtail-palm", "Foxtail Palm", 1400, "Outdoor", foxtailpalm, "Bushy plume-like fronds. Elegant entryway palm.", "Full sun", "Twice weekly", "in"),
  p("tabebuia", "Tabebuia", 800, "Outdoor", bougainvillea, "Cloud of pink trumpet blooms in spring.", "Full sun", "Weekly", "in"),
  p("jacaranda", "Jacaranda", 750, "Outdoor", jacaranda, "Violet-blue blossoms that carpet the ground.", "Full sun", "Weekly", "in"),
  ...
  p("marigold", "Marigold", 150, "Flowering", marigold, "Cheerful orange and yellow blooms. Pest-repellent.", "Full sun", "Daily", "in"),
  p("jasmine", "Jasmine", 450, "Flowering", jasmine, "Fragrant white star-blooms.", "Full to part sun", "Twice weekly", "in"),
  p("mogra", "Mogra", 500, "Flowering", mogra, "Pure white blooms with unforgettable evening fragrance.", "Full to part sun", "Twice weekly", "in", "Jasminum sambac"),
  ...
  p("petunia", "Petunia", 250, "Flowering", petunia, "Trumpet blooms in every colour for balcony pots.", "Full sun", "Daily", "in"),
  p("chrysanthemum", "Chrysanthemum", 300, "Flowering", chrysanthemum, "Pompom blooms in cream, gold, and burgundy.", "Full sun", "Twice weekly", "in"),
  p("dahlia", "Dahlia", 350, "Flowering", dahlia, "Show-stopping double blooms in vivid colours.", "Full sun", "Twice weekly", "in"),
  p("gerbera", "Gerbera", 300, "Flowering", gerbera, "Large daisy-form blooms on long stems.", "Bright sun", "Twice weekly", "in"),
  p("zinnia", "Zinnia", 200, "Flowering", hibiscus, "Heat-loving cut-flower that blooms for months.", "Full sun", "Twice weekly", "in"),
  p("sunflower", "Sunflower", 250, "Flowering", sunflower, "Cheerful golden faces that track the sun.", "Full sun", "Twice weekly", "in"),
  ...
  p("rajnigandha", "Rajnigandha (Tuberose)", 400, "Flowering", tuberose, "Tall white spikes with intoxicating fragrance.", "Full sun", "Twice weekly", "in"),
  ...
  p("tecoma", "Tecoma (Yellow Bells)", 400, "Flowering", tecoma, "Cascades of golden trumpet flowers.", "Full sun", "Weekly", "in"),
  p("adenium", "Adenium (Desert Rose)", 800, "Flowering", adenium, "Sculpted swollen trunk with bright trumpet blooms.", "Full sun", "Weekly", "in"),
  ...
  p("papaya", "Papaya", 350, "Fruit", papaya, "Fast-growing softwood tree. Fruits within a year.", "Full sun", "Twice weekly", "in"),
  p("banana", "Banana", 450, "Fruit", banana, "Tropical broad-leaf with abundant fruit.", "Full sun", "Twice weekly", "in"),
  p("coconut", "Coconut", 1500, "Fruit", coconut, "Iconic coastal palm. Grand entry plant.", "Full sun", "Twice weekly", "in"),
  p("dragon-fruit", "Dragon Fruit", 600, "Fruit", dragonfruit, "Climbing cactus with vibrant exotic fruit.", "Full sun", "Weekly", "in"),
  p("strawberry", "Strawberry", 250, "Fruit", strawberry, "Compact basket-friendly fruiter for cool months.", "Bright sun", "Twice weekly", "in"),
  ...
  p("jamun", "Jamun", 700, "Fruit", jamun, "Deep purple Indian fruit with sweet-astringent bite.", "Full sun", "Twice weekly", "in"),
  ...
  p("fig", "Fig (Anjeer)", 800, "Fruit", fig, "Sweet honeyed fruit on a hardy tree.", "Full sun", "Weekly", "in"),
  p("avocado", "Avocado", 1200, "Fruit", avocado, "Buttery superfruit for sunny terraces.", "Full sun", "Weekly", "in"),
  ...
  p("pineapple", "Pineapple", 500, "Fruit", pineapple, "Striking rosette with one prized fruit per cycle.", "Full sun", "Weekly", "in"),
  ...
  p("amla-fruit", "Indian Gooseberry (Amla)", 550, "Fruit", amla, "Vitamin-rich sour-sweet superfruit.", "Full sun", "Twice weekly", "in"),

  // ============= AYURVEDIC (30) =============
  p("tulsi", "Tulsi (Holy Basil)", 200, "Ayurvedic", tulsi, "Sacred aromatic herb for tea and worship.", "Full to part sun", "Twice weekly", "in", "Ocimum sanctum"),
  ...
  p("curry-leaf", "Curry Leaf", 350, "Ayurvedic", curryleaf, "Aromatic kitchen essential with medicinal use.", "Full to part sun", "Twice weekly", "in"),
  p("lemongrass", "Lemongrass", 300, "Ayurvedic", lemongrass, "Citrus herb for tea, oils, and cooking.", "Full sun", "Twice weekly", "in"),
  p("mint", "Mint (Pudina)", 200, "Ayurvedic", mint, "Cooling kitchen herb that spreads happily.", "Bright indirect", "Twice weekly", "in"),
  ...
  p("turmeric", "Turmeric (Haldi)", 300, "Ayurvedic", turmeric, "Golden-root anti-inflammatory.", "Part sun", "Twice weekly", "in"),
  p("ginger", "Ginger (Adrak)", 300, "Ayurvedic", ginger, "Warm digestive root for tea and cooking.", "Part sun", "Twice weekly", "in"),
  ...
  p("zebra-haworthia", "Zebra Haworthia", 350, "Succulents", haworthia, "Striking white-banded mini rosette.", "Bright indirect", "Every 2 weeks", "in"),
  ...
  p("string-pearls", "String of Pearls", 450, "Succulents", stringpearls, "Cascading beads for hanging baskets.", "Bright sun", "Every 2 weeks", "in"),
  ...
  p("lithops", "Lithops (Living Stones)", 500, "Succulents", lithops, "Tiny living-stone curiosity.", "Bright sun", "Monthly", "in"),
  ...
  p("agave", "Agave", 600, "Succulents", agave, "Sculptural sword-rosette for sunny terraces.", "Full sun", "Every 2 weeks", "in"),
