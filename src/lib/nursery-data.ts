...
export const plants: Plant[] = [
  ...
  p("marigold", "Marigold", 150, "Flowering", rose, "Cheerful orange and yellow blooms. Pest-repellent.", "Full sun", "Daily", "in"),
  p("jasmine", "Jasmine", 450, "Flowering", jasmine, "Fragrant white star-blooms.", "Full to part sun", "Twice weekly", "in"),
  p("mogra", "Mogra Jasmine", 500, "Flowering", jasmine, "Pure white blooms with unforgettable evening fragrance.", "Full to part sun", "Twice weekly", "in", "Jasminum sambac"),
  ...
  p("petunia", "Petunia", 250, "Flowering", rose, "Trumpet blooms in every colour for balcony pots.", "Full sun", "Daily", "in"),
  ...
  p("zinnia", "Zinnia", 200, "Flowering", rose, "Heat-loving cut-flower that blooms for months.", "Full sun", "Twice weekly", "in"),
  p("sunflower", "Sunflower", 250, "Flowering", rose, "Cheerful golden faces that track the sun.", "Full sun", "Twice weekly", "in"),
  p("cosmos", "Cosmos", 200, "Flowering", rose, "Airy pink and white meadow blooms.", "Full sun", "Twice weekly", "in"),
  p("pansy", "Pansy", 250, "Flowering", rose, "Velvety bicolour blooms for cool-season pots.", "Bright sun", "Twice weekly", "in"),
  p("calendula", "Calendula", 200, "Flowering", rose, "Golden-orange blooms with herbal uses.", "Full sun", "Twice weekly", "in"),
  p("portulaca", "Portulaca", 150, "Flowering", echeveria, "Heat-loving moss-rose carpet in jewel tones.", "Full sun", "Weekly", "in"),
  p("gaillardia", "Gaillardia (Blanket Flower)", 250, "Flowering", rose, "Sunset-bicolour daisies that bloom forever.", "Full sun", "Weekly", "in"),
  p("verbena", "Verbena", 250, "Flowering", rose, "Compact clusters in purple, pink, and red.", "Full sun", "Twice weekly", "in"),
  p("salvia", "Salvia", 300, "Flowering", rose, "Spiky purple or red flower wands.", "Full sun", "Twice weekly", "in"),
  p("lantana", "Lantana", 250, "Flowering", rose, "Multi-colour clusters that attract butterflies.", "Full sun", "Weekly", "in"),
  ...
  p("poinsettia", "Poinsettia", 450, "Flowering", croton, "Christmas star with flame-red bracts.", "Bright indirect", "Weekly", "in"),
  ...
  p("adenium", "Adenium (Desert Rose)", 800, "Flowering", cactus, "Sculpted swollen trunk with bright trumpet blooms.", "Full sun", "Weekly", "in"),
